  ...
  return (
    <>
      <section className='mt-8' id='transaction'>
        <div className='bg-white border-2 border-gray-100 rounded p-2 py-4'>
          <h2 className='text-2xl text-emerald-500 text-center mt-2 font-semibold'>
            المعاملات الاخيرة
          </h2>
          <div className='bg-white rounded max-sm:overflow-x-scroll'>
            <table className='w-full border border-gray-200 rounded-lg mt-8'>
              <thead className=''>
                <tr className=''>
